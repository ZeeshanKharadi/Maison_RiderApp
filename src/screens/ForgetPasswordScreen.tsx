...
import { saveUserIdWithExpiry } from './CreateAccountScreen';
import {
  BACKGROUND,
  BORDER_INPUT,
  BRAND_RED,
        ...
        <ScrollView contentContainerStyle={styles.scroll}>
          ...
          <View style={styles.headerSection}>
            <View style={styles.iconCircle}>
              <Icon name="lock-reset" size={36} color={BRAND_RED} />
            </View>
            <Text style={styles.title}>Forgot Password</Text>
            <Text style={styles.subtitle}>
              Enter your Employee ID and we'll send a verification code to
              reset your password.
            </Text>
          </View>
